...
<body style="background-color: #F9F5EA;">
    ...
    <div class="comm_main">
       ...
       <div class="write_container">
          <div class="writeBox">
            <table class="com_table" style="text-align: center; border-collapse: separate; border-spacing: 0 10px; width:100%;">
				 <thead>
				...
				<tbody>
					...
					<tr>
						...
						<td><%= list.get(i).getBbsDate().substring(11, 13) 
			...
			<%
				if (pageNumber != 1) {
			%>
				<a href="community.jsp?pageNumber=<%=pageNumber - 1%>" class="btn">이전</a>
			<%
				} if (bbsDAO.nextPage(pageNumber + 1)) {
			%>
				<a href="community.jsp?pageNumber=<%=pageNumber + 1%>" class="btn">다음</a>
			<%
				}
			%>	
            </div>
