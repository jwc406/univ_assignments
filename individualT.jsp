            ...
            <div class="right" id="Btn1">
               <div class="contents">
                  <div class="box" style="border-bottom: 2px solid #8a611e;">
                     <h1>&nbsp지역 선택</h1>
                     <span class="location"><a onclick="getUserLocation();">내주변&nbsp</a></span>
                     <script>
               ...
               <div class="box2" id="Seoul">
                  <div class="left2">
                     ...
                     <div class="right2" style="background-color: rgba(0255, 176, 46, 0.7);">
                        ...
                        <button class="request">요청하기</button>
                     </div>
                  </div>
                  <div class="right2">
                     <div class="left2" style="background-color: rgba(0255, 176, 46, 0.2);">
         ...
         <div class="right" id="Btn2" style="overflow: visible;">
            <div class="contents">
               ...
               <div class="box3">
                  <br>
                  <span class="buttons">
                     <tr><button class="make">생성하기</button></tr>
                     <tr><button class="cancel">취소하기</button></tr>
                  </span>
               </div>
            </div>
         </div>
