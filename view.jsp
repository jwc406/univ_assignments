          ...
          <div class="writeBox">
			<table class="view_table" 
				...
				<thead>
					...
					<tr style="">
						<th style="text-align: left; padding: 5px 12px; font-size: 12px; width:80px; border-bottom: 2px solid #ddd;">
				...
				<tbody>
					...
					<tr>
						<td colspan="6" style="height: auto; text-align: left; padding:20px 25px; font-size: 15px;"><%= 
							bbs.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
							.replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td> <!-- 내용 -->
					</tr>
				</tbody>
			</table><div style="display: flex; justify-content: space-around; margin-top: 30px;" class="view_menu">
