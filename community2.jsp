        ...
        <div class="btns_container">
            <div class="btns">
                ...
                <button class="btn" onclick="location.href='community2.jsp'"
                    style="background-color: white; color:#FFB02E;">글 작성</button>
                <button class=" btn" onclick="location.href='community3.jsp'">방명록</button>
            </div>
        </div>
        <div class="write_container">
            <div class="writeBox">
                <form method="post" class="writePost" action="writeAction.jsp">
                ...
                <div class="writeBox_btns">
                    <input type="button" value="취소" onclick="alert('글 작성을 취소했습니다 😥', location.href='community.jsp')">
